      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-14 lg:pt-16 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-10 lg:gap-14 items-start">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-[2rem] sm:text-4xl lg:text-[3rem] xl:text-[3.25rem] font-bold text-navy-900 leading-[1.08] tracking-[-0.025em] mb-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
              <a
                href="tel:5307046989"
                className="h-14 px-8 bg-primary text-white font-semibold rounded-full inline-flex items-center justify-center gap-2 hover:bg-primary-dark hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] active:shadow-md transition-[transform,box-shadow,background-color] duration-200 ease-snappy shadow-lg text-base"
              >
              ...
              <a
                href="#estimate-form"
                className="h-14 px-8 bg-white text-navy-900 font-semibold rounded-full inline-flex items-center justify-center gap-2 border-2 border-navy-900 hover:bg-navy-900 hover:text-white hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] transition-[transform,background-color,color,box-shadow] duration-200 ease-snappy text-base"
              >
                Book Your Service
              </a>
            </div>
            ...
            <div className="mt-7 pt-6 border-t border-gray-200/60">
              <p className="text-[11px] font-semibold tracking-[0.15em] text-gray-400 uppercase mb-4 text-center lg:text-left">
                Trusted &amp; Reviewed Across
              </p>
              <div className="flex flex-wrap justify-center lg:justify-start gap-x-8 gap-y-4 items-center">
                {/* Google Reviews */}
                <div className="flex items-center gap-2.5">
                  <svg className="w-7 h-7 text-gray-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                  ...
                  <div>
                    <div className="flex text-gray-400">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden>
                ...
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 bg-gray-300 rounded-lg flex items-center justify-center">
                    <span className="text-white text-[11px] font-bold leading-none">BBB</span>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-500">A+ Rating</span>
                    <br />
                    <span className="text-xs text-gray-400">Better Business Bureau</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-500 font-medium">Yelp Reviews</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 bg-gray-200 rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <div>
                    <span className="text-sm font-bold text-gray-500">Licensed &amp; Insured</span>
                    <br />
                    <span className="text-xs text-gray-400">California CSLB</span>
                  </div>
                </div>
              </div>
            </div>
