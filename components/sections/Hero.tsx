        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-8 lg:gap-12 items-center">
          ...
          <div className="text-white text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <a
                href="tel:5307689446"
                className="h-14 px-8 bg-secondary text-white font-btn font-semibold rounded-full inline-flex items-center justify-center gap-2 hover:shadow-[0_4px_12px_rgba(230,57,70,0.4)] hover:-translate-y-[2px] focus-visible:-translate-y-[2px] transition-all duration-200 shadow-lg text-base md:text-lg touch-target"
              >
              ...
              <a
                href="/contact"
                className="h-14 px-8 bg-primary text-white font-btn font-bold rounded-full inline-flex items-center justify-center gap-2 hover:shadow-brand hover:-translate-y-[2px] focus-visible:-translate-y-[2px] transition-all duration-200 shadow-lg text-base md:text-lg uppercase tracking-wide touch-target"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
