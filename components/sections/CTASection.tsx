      ...
      <div className="max-w-7xl mx-auto container-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center lg:items-end gap-4">
            <a
              href="tel:5307046989"
              className="h-14 px-8 bg-primary text-white font-btn font-semibold rounded-xl inline-flex items-center justify-center gap-3 hover:bg-primary-dark hover:shadow-lg hover:-translate-y-1 active:translate-y-0 focus-visible:-translate-y-1 transition-all duration-300 ease-[cubic-bezier(0.25,0.8,0.25,1)] shadow-lg text-lg touch-target w-full sm:w-auto"
            >
