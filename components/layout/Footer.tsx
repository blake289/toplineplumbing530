        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex items-center justify-center w-11 h-11 rounded-full bg-white/5 border border-white/10 text-white/70 hover:text-white hover:border-white/30 hover:bg-white/10 transition-all"
              >
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-col gap-1 text-[15px]">
              ...
              <a href="mailto:Toplineplumbingredding@gmail.com" className="text-gray-400 hover:text-white transition-colors break-all py-2.5">
                Toplineplumbingredding@gmail.com
              </a>
              <p className="text-gray-400 py-1">Serving Redding &amp; Northern California</p>
              <a
                href="https://go.toplineplumbingco.com/google_review"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-primary-light hover:text-white transition-colors text-[14px] font-medium py-2.5"
              >
