...
export default function HeroEstimateForm({ formLocation = 'hero' }: { formLocation?: string }) {
  ...
  return (
    <form id="hero_estimate" name="Hero Estimate Form" onSubmit={handleSubmit(onSubmit)} className="space-y-3">
      ...
      <p className="flex items-center justify-center gap-1.5 text-[12px] text-gray-500 -mb-1">
        <svg className="w-3.5 h-3.5 text-accent-green flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden>
          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        </svg>
        Free, no-obligation estimate · We reply Mon&ndash;Fri 8a&ndash;4:30p
      </p>
