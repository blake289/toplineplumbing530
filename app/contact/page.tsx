            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-sm text-gray-600 uppercase tracking-wide mb-1">Phone</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-sm text-gray-600 uppercase tracking-wide mb-1">Email</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-sm text-gray-600 uppercase tracking-wide mb-1">Service Area</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-sm text-gray-600 uppercase tracking-wide mb-1">Hours</h3>
