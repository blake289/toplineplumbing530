...
export const metadata: Metadata = {
  ...
  description: 'Licensed plumber in Chico, California. 24/7 emergency plumbing, drain cleaning, water heater repair. Same-day service in Chico. Call (530) 704-6989',
  alternates: { canonical: 'https://toplineplumbingco.com/areas/chico' },
  openGraph: {
    title: 'Plumber in Chico, CA | Topline Plumbing',
    description: 'Licensed plumber in Chico, California. 24/7 emergency plumbing, drain cleaning, water heater repair. Same-day service in Chico. Call (530) 704-6989',
    url: 'https://toplineplumbingco.com/areas/chico',
    siteName: 'Topline Plumbing',
    images: [{ url: '/images/water-heater.webp', width: 1200, height: 630, alt: 'Topline Plumbing — Licensed Plumber in Chico, CA' }],
    locale: 'en_US',
    type: 'website',
  },
};

export default function ChicoPage() {
  return (
    <>
      <BreadcrumbSchema items={[
        { name: 'Home', url: 'https://toplineplumbingco.com' },
        { name: 'Areas Served', url: 'https://toplineplumbingco.com/areas' },
        { name: 'Plumber in Chico, CA', url: 'https://toplineplumbingco.com/areas/chico' },
      ]} />
      <FAQSchema faqs={getCityFaqs('chico')} />
      {/* Hero */}
      <section className="py-20 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Licensed Plumber in Chico, California</h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
            Professional plumbing service in Chico, CA. Licensed plumbers for emergency plumbing, drain cleaning, water heater repair, leak detection, and all residential & commercial plumbing needs. Same-day service available.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <h2 className="text-3xl font-bold text-gray-900">Your Trusted Plumber in Chico, California</h2>
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Chico, Butte County with professional plumbing services. Our licensed plumbers have been serving Chico homeowners and businesses for 15+ years, completing thousands of plumbing jobs across Northern California with a 4.9-star rating.
              </p>
              <p className="text-lg text-gray-700">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline">24/7 Emergency Plumber Chico</Link>
                  </h3>
                  <p className="text-gray-700">Plumbing emergencies don't wait for business hours. Our emergency plumbers respond 24/7 to burst pipes, water heater flooding, sewer backups, and all plumbing emergencies in Chico. Average response time: 60 minutes.</p>
                </div>
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Why Chico Homeowners Choose Topline Plumbing</h2>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Local Chico Plumbers:</strong> We serve Chico and know the area's plumbing challenges</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Fast Response in Chico:</strong> Same-day service available, 24/7 emergency plumbing</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Emergency Plumber Chico - 24/7 Service</h2>
              <p className="text-gray-700">
                When you have a plumbing emergency in Chico — burst pipe, water heater flooding, sewer backup, or any urgent plumbing problem — call Topline Plumbing 530 immediately at <strong>(530) 704-6989</strong>. Our emergency plumbers are on-call 24 hours a day, 7 days a week, 365 days a year.
              </p>
            </div>
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-primary text-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold mb-2">Chico Plumber</h3>
      ...
      {/* FAQ Section */}
      <FAQSection faqs={getCityFaqs('chico')} />

      {/* CTA Section */}
      <section className="py-16 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need a Plumber in Chico?</h2>
          <p className="text-xl text-gray-200 mb-8">Licensed plumbers ready to help. Same-day service available in Chico, California.</p>
