          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Chico, Butte County with professional plumbing services. Our licensed plumbers have been serving Chico homeowners and businesses since 1998, completing thousands of plumbing jobs across Northern California with a 4.9-star rating.
              </p>
              <p className="text-lg text-gray-700">
