...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  '@id': 'https://toplineplumbingco.com/areas/redding#webpage',
  url: 'https://toplineplumbingco.com/areas/redding',
  name: 'Plumber in Redding, CA | Topline Plumbing',
  description:
    'Licensed plumber in Redding, California. Same-day emergency plumbing, drain cleaning, water heater repair, and leak detection. Licensed since 1998, CSLB #596557.',
  inLanguage: 'en-US',
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/areas/redding#service',
  serviceType: 'Plumbing',
  name: 'Plumbing Services in Redding, CA',
    ...
    <>
      ...
      <section className="py-20 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Licensed Plumber in Redding, California</h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
            Professional plumbing service in Redding, CA. Licensed plumbers for emergency plumbing, drain cleaning, water heater repair, leak detection, and all residential & commercial plumbing needs. Same-day service available.
          </p>
        </div>
      </section>
      ...
      <LocalContext profile={getCityProfile('redding')} />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <h2 className="text-3xl font-bold text-gray-900">Your Trusted Plumber in Redding, California</h2>
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Redding, Shasta County with professional plumbing services. Our licensed plumbers have been serving Redding homeowners and businesses since 1998, completing thousands of plumbing jobs across Northern California with a 5-Star Rated.
              </p>
              <p className="text-lg text-gray-700">
                Whether you need same-day emergency repair during business hours (Mon–Fri 8:00a–4:30p) or a scheduled water heater installation, our licensed plumbers are ready to help. We offer same-day plumbing service for most repairs in Redding and surrounding areas.
              </p>

              <h2 className="text-3xl font-bold text-gray-900 pt-6">Complete Plumbing Services in Redding CA</h2>

              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline block py-2">Emergency Plumber Redding</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/drain-cleaning" className="text-blue-600 hover:underline block py-2">Drain Cleaning Service Redding</Link>
                  </h3>
                  <p className="text-gray-700">Clogged drain in Redding? Slow bathroom drain? Kitchen sink backup? Our licensed plumbers provide professional drain cleaning using advanced equipment. We clear clogged drains fast — usually in under an hour.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/water-heater-repair" className="text-blue-600 hover:underline block py-2">Water Heater Repair & Installation Redding</Link>
                  </h3>
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Why Redding Homeowners Choose Topline Plumbing</h2>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Local Redding Plumbers:</strong> We serve Redding and know the area's plumbing challenges</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Plumbing Service Areas Near Redding</h2>
              <p className="text-gray-700 mb-4">In addition to Redding, we provide licensed plumbing service throughout Northern California including:</p>
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-primary text-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold mb-2">Redding Plumber</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Redding Services</h3>
                <ul>
      ...
      <section className="py-16 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need a Plumber in Redding?</h2>
          <p className="text-xl text-gray-200 mb-8">Licensed plumbers ready to help. Same-day service available in Redding, California.</p>
