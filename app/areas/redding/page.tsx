...
export const metadata = {
  title: 'Plumber Redding CA | Licensed Plumbing Service | Topline Plumbing 530',
  description: 'Licensed plumber in Redding, California. 24/7 emergency plumbing, drain cleaning, water heater repair. Same-day service in Redding. Call (530) 768-9446',
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Redding, Shasta County with professional plumbing services. Our licensed plumbers have been serving Redding homeowners and businesses for 15+ years, completing thousands of plumbing jobs across Northern California with a 4.9-star rating.
              </p>
              <p className="text-lg text-gray-700">
                Whether you need emergency plumbing service at 2am or a scheduled water heater installation, our licensed plumbers in Redding are ready to help. We offer same-day plumbing service for most repairs in Redding and surrounding areas.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/drain-cleaning" className="text-blue-600 hover:underline">Drain Cleaning Service Redding</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/tankless" className="text-blue-600 hover:underline">Tankless Water Heater Installation Redding</Link>
                  </h3>
              ...
              <p className="text-gray-700">
                When you have a plumbing emergency in Redding — burst pipe, water heater flooding, sewer backup, or any urgent plumbing problem — call Topline Plumbing 530 immediately at <strong>(530) 768-9446</strong>. Our emergency plumbers are on-call 24 hours a day, 7 days a week, 365 days a year.
              </p>
            </div>
