...
export const metadata: Metadata = {
  ...
  description: 'Licensed plumber in Red Bluff, California. 24/7 emergency plumbing, drain cleaning, water heater repair. Same-day service in Red Bluff. Call (530) 704-6989',
  alternates: { canonical: 'https://toplineplumbingco.com/areas/red-bluff' },
  openGraph: {
    title: 'Plumber in Red Bluff, CA | Topline Plumbing',
    description: 'Licensed plumber in Red Bluff, California. 24/7 emergency plumbing, drain cleaning, water heater repair. Same-day service in Red Bluff. Call (530) 704-6989',
    url: 'https://toplineplumbingco.com/areas/red-bluff',
    siteName: 'Topline Plumbing',
    images: [{ url: '/images/water-heater.webp', width: 1200, height: 630, alt: 'Topline Plumbing — Licensed Plumber in Red Bluff, CA' }],
    locale: 'en_US',
    type: 'website',
  },
};
    ...
    <>
      ...
      <section className="py-20 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Licensed Plumber in Red Bluff, California</h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
            Professional plumbing service in Red Bluff, CA. Licensed plumbers for emergency plumbing, drain cleaning, water heater repair, leak detection, and all residential & commercial plumbing needs. Same-day service available.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <h2 className="text-3xl font-bold text-gray-900">Your Trusted Plumber in Red Bluff, California</h2>
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Red Bluff, Tehama County with professional plumbing services. Our licensed plumbers have been serving Red Bluff homeowners and businesses for 15+ years, completing thousands of plumbing jobs across Northern California with a 4.9-star rating.
              </p>
              <p className="text-lg text-gray-700">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline">24/7 Emergency Plumber Red Bluff</Link>
                  </h3>
                  <p className="text-gray-700">Plumbing emergencies don't wait for business hours. Our emergency plumbers respond 24/7 to burst pipes, water heater flooding, sewer backups, and all plumbing emergencies in Red Bluff. Average response time: 60 minutes.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/drain-cleaning" className="text-blue-600 hover:underline">Drain Cleaning Service Red Bluff</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/water-heater-repair" className="text-blue-600 hover:underline">Water Heater Repair & Installation Red Bluff</Link>
                  </h3>
                  <p className="text-gray-700">No hot water in Red Bluff? Water heater leaking? Strange noises? Our plumbers specialize in water heater repair and replacement. Same-day water heater service available in Red Bluff.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/tankless" className="text-blue-600 hover:underline">Tankless Water Heater Installation Red Bluff</Link>
                  </h3>
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Why Red Bluff Homeowners Choose Topline Plumbing</h2>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Local Red Bluff Plumbers:</strong> We serve Red Bluff and know the area's plumbing challenges</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Fast Response in Red Bluff:</strong> Same-day service available, 24/7 emergency plumbing</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Emergency Plumber Red Bluff - 24/7 Service</h2>
              <p className="text-gray-700">
                When you have a plumbing emergency in Red Bluff — burst pipe, water heater flooding, sewer backup, or any urgent plumbing problem — call Topline Plumbing 530 immediately at <strong>(530) 704-6989</strong>. Our emergency plumbers are on-call 24 hours a day, 7 days a week, 365 days a year.
              </p>
            </div>
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-primary text-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold mb-2">Red Bluff Plumber</h3>
      ...
      {/* FAQ Section */}
      <FAQSection faqs={getCityFaqs('red-bluff')} />

      {/* CTA Section */}
      <section className="py-16 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need a Plumber in Red Bluff?</h2>
          <p className="text-xl text-gray-200 mb-8">Licensed plumbers ready to help. Same-day service available in Red Bluff, California.</p>
