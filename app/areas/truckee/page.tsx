...
export const metadata: Metadata = {
  ...
  description: 'Licensed plumber in Truckee, California. Same-day emergency plumbing, drain cleaning, water heater repair. Same-day service in Truckee. Call (530) 704-6989',
  alternates: { canonical: 'https://toplineplumbingco.com/areas/truckee' },
  openGraph: {
    title: 'Plumber in Truckee, CA | Topline Plumbing',
    description: 'Licensed plumber in Truckee, California. Same-day emergency plumbing, drain cleaning, water heater repair. Same-day service in Truckee. Call (530) 704-6989',
    url: 'https://toplineplumbingco.com/areas/truckee',
    siteName: 'Topline Plumbing',
    images: [{ url: '/images/water-heater.webp', width: 1200, height: 630, alt: 'Topline Plumbing — Licensed Plumber in Truckee, CA' }],
    locale: 'en_US',
    type: 'website',
  },
};
...
export default function TruckeePage() {
  return (
    <>
      ...
      <LocalContext profile={getCityProfile('truckee')} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Truckee, Nevada County with professional plumbing services. Our licensed plumbers have been serving Truckee homeowners and businesses since 1998, completing thousands of plumbing jobs across Northern California with a 5-Star Rated.
              </p>
              <p className="text-lg text-gray-700">
                Whether you need same-day emergency repair during business hours (Mon–Fri 8:00a–4:30p) or a scheduled water heater installation, our licensed plumbers are ready to help. We offer same-day plumbing service for most repairs in Truckee and surrounding areas.
              </p>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline block py-2">Emergency Plumber Truckee</Link>
                  </h3>
                  <p className="text-gray-700">Topline handles plumbing emergencies in Truckee during business hours (Mon–Fri 8:00a–4:30p) — burst pipes, water heater flooding, sewer backups, and all urgent plumbing problems. Same-day response across the Redding area.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/drain-cleaning" className="text-blue-600 hover:underline block py-2">Drain Cleaning Service Truckee</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/water-heater-repair" className="text-blue-600 hover:underline block py-2">Water Heater Repair & Installation Truckee</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/tankless" className="text-blue-600 hover:underline block py-2">Tankless Water Heater Installation Truckee</Link>
                  </h3>
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Fast Response in Truckee:</strong> Same-day service during business hours (Mon–Fri 8:00a–4:30p)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      {/* FAQ Section */}
      <FAQSection faqs={getCityFaqs('truckee')} />
