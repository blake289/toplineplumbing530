...
export const metadata: Metadata = {
  ...
  description: 'Licensed plumber in Truckee, California. 24/7 emergency plumbing, drain cleaning, water heater repair. Same-day service in Truckee. Call (530) 704-6989',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Truckee, Nevada County with professional plumbing services. Our licensed plumbers have been serving Truckee homeowners and businesses since 1998, completing thousands of plumbing jobs across Northern California with a 4.9-star rating.
              </p>
              <p className="text-lg text-gray-700">
              ...
              <p className="text-gray-700">
                When you have a plumbing emergency in Truckee — burst pipe, water heater flooding, sewer backup, or any urgent plumbing problem — call Topline Plumbing 530 immediately at <strong>(530) 704-6989</strong>. Our emergency plumbers are on-call 24 hours a day, 7 days a week, 365 days a year.
              </p>
            </div>
