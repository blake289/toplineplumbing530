...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  '@id': 'https://toplineplumbingco.com/areas/grass-valley#webpage',
  url: 'https://toplineplumbingco.com/areas/grass-valley',
  name: 'Plumber in Grass Valley, CA | Topline Plumbing',
  description:
    'Licensed plumber in Grass Valley, California. Same-day emergency plumbing, drain cleaning, water heater repair, and leak detection. Licensed since 1998, CSLB #596557.',
  inLanguage: 'en-US',
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/areas/grass-valley#service',
  serviceType: 'Plumbing',
  name: 'Plumbing Services in Grass Valley, CA',
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Fast Response in Grass Valley:</strong> Same-day service during business hours (Mon–Fri 8:00a–4:30p)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
