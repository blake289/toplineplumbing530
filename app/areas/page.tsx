...
const serviceAreas = [
  ...
  },
  {
    ...
    slug: 'millville',
    county: 'Shasta County',
    description: 'Licensed plumbing for rural Millville — well systems, septic-safe drain cleaning, and water heater service.',
    primary: true,
  },
  {
    city: 'Cottonwood',
    slug: 'cottonwood',
    county: 'Shasta County',
    description: 'Plumbing service across Cottonwood — well and septic systems, sewer lines, and water heaters, town or rural.',
    primary: true,
  },
  {
    city: 'Happy Valley',
    slug: 'happy-valley',
    county: 'Shasta County',
    description: 'Licensed plumbing for rural Happy Valley — well systems, septic-safe drains, and sewer line service.',
    primary: true,
  },
  {
    city: 'Igo',
    slug: 'igo',
    county: 'Shasta County',
    description: 'Plumbing for rural west-county Igo — well-system service, septic-safe drain cleaning, and burst pipe repair.',
    primary: true,
  },
  {
    city: 'Red Bluff',
  ...
  },
  {
    ...
    county: 'Tehama County',
    description: 'Residential plumbing for the Lake California community — water heaters, drains, leak detection, and repiping.',
    primary: false,
  },
];
