...
export const metadata = {
  title: 'Plumber Paradise CA | Licensed Plumbing Service | Topline Plumbing 530',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Paradise, Butte County with professional plumbing services. Our licensed plumbers have been serving Paradise homeowners and businesses for 15+ years, completing thousands of plumbing jobs across Northern California with a 4.9-star rating.
              </p>
              <p className="text-lg text-gray-700">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline">24/7 Emergency Plumber Paradise</Link>
                  </h3>
                  <p className="text-gray-700">Plumbing emergencies don't wait for business hours. Our emergency plumbers respond 24/7 to burst pipes, water heater flooding, sewer backups, and all plumbing emergencies in Paradise. Average response time: 60 minutes.</p>
                </div>
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Fast Response in Paradise:</strong> Same-day service available, 24/7 emergency plumbing</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
