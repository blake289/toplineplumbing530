        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-lg text-gray-700">
                Whether you need emergency plumbing service at 2am or a scheduled water heater installation, our licensed plumbers in Paradise are ready to help. We offer same-day plumbing service for most repairs in Paradise and surrounding areas.
              </p>
