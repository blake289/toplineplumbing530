              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline">Emergency Plumber Paradise</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/drain-cleaning" className="text-blue-600 hover:underline">Drain Cleaning Service Paradise</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/water-heater-repair" className="text-blue-600 hover:underline">Water Heater Repair & Installation Paradise</Link>
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/tankless" className="text-blue-600 hover:underline">Tankless Water Heater Installation Paradise</Link>
                  </h3>
