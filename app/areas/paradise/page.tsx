...
export const metadata: Metadata = {
  ...
  description: 'Licensed plumber in Paradise, California. Same-day emergency plumbing, drain cleaning, water heater repair. Same-day service in Paradise. Call (530) 704-6989',
...
const webPageSchema = {
  ...
  '@type': 'WebPage',
  '@id': 'https://toplineplumbingco.com/areas/paradise#webpage',
  url: 'https://toplineplumbingco.com/areas/paradise',
  name: 'Plumber in Paradise, CA | Topline Plumbing',
  description:
    'Licensed plumber in Paradise, California. Same-day emergency plumbing, drain cleaning, water heater repair, and leak detection. Licensed since 1998, CSLB #596557.',
  inLanguage: 'en-US',
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/areas/paradise#service',
  serviceType: 'Plumbing',
  name: 'Plumbing Services in Paradise, CA',
  ...
  return (
    <>
      ...
      <FAQSchema faqs={getCityFaqs('paradise')} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(webPageSchema) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }} />
      {/* Hero */}
      <section className="py-20 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Licensed Plumber in Paradise, California</h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
            Professional plumbing service in Paradise, CA. Licensed plumbers for emergency plumbing, drain cleaning, water heater repair, leak detection, and all residential & commercial plumbing needs. Same-day service available.
          </p>
        </div>
      </section>
      ...
      <LocalContext profile={getCityProfile('paradise')} />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              <h2 className="text-3xl font-bold text-gray-900">Your Trusted Plumber in Paradise, California</h2>
              <p className="text-lg text-gray-700">
                Topline Plumbing 530 is proud to serve Paradise, Butte County with professional plumbing services. Our licensed plumbers have been serving Paradise homeowners and businesses since 1998, completing thousands of plumbing jobs across Northern California with a 5-Star Rated.
              </p>
              <p className="text-lg text-gray-700">
                Whether you need same-day emergency repair during business hours (Mon–Fri 8:00a–4:30p) or a scheduled water heater installation, our licensed plumbers are ready to help. We offer same-day plumbing service for most repairs in Paradise and surrounding areas.
              </p>

              <h2 className="text-3xl font-bold text-gray-900 pt-6">Complete Plumbing Services in Paradise CA</h2>

              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/emergency" className="text-blue-600 hover:underline block py-2">Emergency Plumber Paradise</Link>
                  </h3>
                  <p className="text-gray-700">Topline handles plumbing emergencies in Paradise during business hours (Mon–Fri 8:00a–4:30p) — burst pipes, water heater flooding, sewer backups, and all urgent plumbing problems. Same-day response across the Redding area.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/drain-cleaning" className="text-blue-600 hover:underline block py-2">Drain Cleaning Service Paradise</Link>
                  </h3>
                  <p className="text-gray-700">Clogged drain in Paradise? Slow bathroom drain? Kitchen sink backup? Our licensed plumbers provide professional drain cleaning using advanced equipment. We clear clogged drains fast — usually in under an hour.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/water-heater-repair" className="text-blue-600 hover:underline block py-2">Water Heater Repair & Installation Paradise</Link>
                  </h3>
                  <p className="text-gray-700">No hot water in Paradise? Water heater leaking? Strange noises? Our plumbers specialize in water heater repair and replacement. Same-day water heater service available in Paradise.</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 mb-2">
                    <Link href="/services/tankless" className="text-blue-600 hover:underline block py-2">Tankless Water Heater Installation Paradise</Link>
                  </h3>
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Why Paradise Homeowners Choose Topline Plumbing</h2>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Local Paradise Plumbers:</strong> We serve Paradise and know the area's plumbing challenges</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Fast Response in Paradise:</strong> Same-day service during business hours (Mon–Fri 8:00a–4:30p)</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <h2 className="text-3xl font-bold text-gray-900 pt-8">Plumbing Service Areas Near Paradise</h2>
              <p className="text-gray-700 mb-4">In addition to Paradise, we provide licensed plumbing service throughout Northern California including:</p>
            ...
            <aside className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Paradise Services</h3>
                <ul>
      ...
      {/* FAQ Section */}
      <FAQSection faqs={getCityFaqs('paradise')} />

      {/* CTA Section */}
      <section className="py-16 bg-navy-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Need a Plumber in Paradise?</h2>
