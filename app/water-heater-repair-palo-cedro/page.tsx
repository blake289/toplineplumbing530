...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/water-heater-repair-palo-cedro#service',
  name: 'Water Heater Repair in Palo Cedro, CA',
  serviceType: 'Water Heater Repair',
  description:
    'Water heater repair in Palo Cedro, CA — gas and electric, including well-fed and propane systems. We diagnose and repair thermostats, heating elements, thermocouples, gas control valves, pilot/ignition faults, and leaking T&P relief valves, with honest repair-vs-replace guidance and upfront pricing. Licensed plumber CSLB #596557, serving the Palo Cedro and Redding area since 1998.',
  category: 'Plumbing',
  url: 'https://toplineplumbingco.com/water-heater-repair-palo-cedro',
...
const webPageSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  '@id': 'https://toplineplumbingco.com/water-heater-repair-palo-cedro#webpage',
  url: 'https://toplineplumbingco.com/water-heater-repair-palo-cedro',
  name: 'Water Heater Repair Palo Cedro, CA | Topline Plumbing',
  description:
    "Water heater repair in Palo Cedro, CA, gas and electric — well-water and rural homes welcome. Same-day diagnostic and honest repair-vs-replace advice. Licensed since 1998. Call (530) 704-6989.",
  inLanguage: 'en-US',
  isPartOf: { '@id': 'https://toplineplumbingco.com/#website' },
  about: { '@id': 'https://toplineplumbingco.com/water-heater-repair-palo-cedro#service' },
};

export const metadata: Metadata = {
  title: 'Water Heater Repair Palo Cedro, CA | Topline Plumbing',
  description:
    "Water heater repair in Palo Cedro, CA, gas and electric — well-water and rural homes welcome. Same-day diagnostic and honest repair-vs-replace advice. Licensed since 1998. Call (530) 704-6989.",
  alternates: {
    canonical: 'https://toplineplumbingco.com/water-heater-repair-palo-cedro',
  },
  openGraph: {
    title: 'Water Heater Repair Palo Cedro, CA | Topline Plumbing',
    description:
      "Palo Cedro's water heater repair specialists. Same-day diagnostic during business hours, gas and electric, well-water and rural properties — honest repair-vs-replace guidance from a licensed local plumber since 1998.",
    url: 'https://toplineplumbingco.com/water-heater-repair-palo-cedro',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Topline Plumbing — Water Heater Repair in Palo Cedro, CA',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const waterHeaterRepairFAQs = [
  ...
  {
    question: 'Does well water pressure affect my water heater in Palo Cedro?',
    answer:
      "It can. Palo Cedro homes on wells run off a pressure tank, and when that pressure swings too low or too high it stresses the water heater's T&P relief valve and fittings — sometimes showing up as weeping valves or short hot-water runs that look like a tank fault. We check the supply side too, so we're not just swapping a part that the well system will keep killing. Call (530) 704-6989 and let us know you're on a well.",
  },
  {
    question: 'Is Topline Plumbing licensed to repair water heaters?',
    answer:
      'Yes. Topline Plumbing is a licensed, bonded, and insured California plumbing contractor — CSLB License #596557 — serving the Palo Cedro and Redding area since 1998. We stand behind our repair workmanship.',
  },
  {
    question: 'Are you available 24/7 for water heater emergencies in Palo Cedro?',
    answer:
...
export default function WaterHeaterRepairPaloCedroPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            name: 'Water Heater Repair Palo Cedro',
            url: 'https://toplineplumbingco.com/water-heater-repair-palo-cedro',
          },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-3xl text-center lg:text-left mx-auto lg:mx-0">
            <p className="uppercase tracking-widest text-sm md:text-base text-primary-light font-semibold mb-4">
              Palo Cedro&apos;s Water Heater Repair Specialists · Licensed Since 1998
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 text-white leading-tight">
              Water Heater Repair in Palo Cedro, CA
            </h1>
            <p className="text-lg md:text-xl text-gray-200 mb-6 leading-relaxed">
              Topline Plumbing is a licensed (CSLB #596557) water heater repair service for Palo
              Cedro, CA. We repair gas, propane, and electric units — thermostats, heating elements,
              thermocouples, gas valves, pilots, and leaking relief valves — including well-fed and
              rural systems, with same-day service during business hours (Mon–Fri 8a–4:30p) and
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-3">
              Water Heater Repairs We Handle in Palo Cedro
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-gray-400 font-bold flex-shrink-0">—</span>
                  <span>It rumbles loudly from heavy well-water sediment buildup</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-gray-400 font-bold flex-shrink-0">—</span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-6">
              Why Palo Cedro Homes Call Topline for Water Heater Repair
            </h2>
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              ...
              <p>
                Because Palo Cedro is unincorporated, there&apos;s no single water provider here —
                depending on location, water comes from the Bella Vista Water District or a private
                well, and that distinction matters for your water heater. Well-fed homes tend to
                carry heavier sediment and mineral load, which settles in the bottom of the tank,
                insulates the burner or element, and drives early failure — rumbling tanks, tripped
                elements, and worn-out thermostats well before their time. Many of these homes also
                run propane rather than natural gas, and on a private well the whole system rides on
                a pressure tank, so a swing in well pressure can stress the T&amp;P relief valve and
                fittings and masquerade as a tank fault.
              </p>
              <p>
                When we repair a water heater out here, we check the supply side too — the pressure
                tank, the anode rod, whether a flush or a softener/filter would keep the same failure
                from coming straight back — instead of just swapping a part the well system will keep
                killing. Septic-connected homes get the same careful treatment on the drain side: we
                use mechanical methods, not caustics that can damage the system. That&apos;s the
                honest fix, not just the fast one, and it&apos;s why large-lot Palo Cedro homeowners
                keep our number on the fridge.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: 'Thermostats, heating elements, thermocouples, and relief valves ride on the truck, so most water heater repairs — including propane units common out here — are finished in a single visit.',
              },
              {
              ...
              },
              {
                ...
                body: 'CSLB #596557, serving the Palo Cedro and Redding area since 1998. Real local business hours, Mon–Fri 8a–4:30p — no after-hours surcharge games.',
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      {/* Related services in Palo Cedro */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Septic-safe mechanical augering and camera inspection across Palo Cedro.
              </p>
            </Link>
            <Link
            ...
            >
              <h3 className="text-lg font-heading font-bold text-navy-900 mb-2">
                Water Heater Repair in Shasta Lake
              </h3>
              <p className="text-gray-600 text-sm">
                Same service, up the I-5 in the city of Shasta Lake.
              </p>
            </Link>
            <Link
            ...
            >
              <h3 className="text-lg font-heading font-bold text-navy-900 mb-2">
                All Plumbing in Palo Cedro
              </h3>
              <p className="text-gray-600 text-sm">
                Everything we do across Palo Cedro&apos;s ranches and large-lot homes.
              </p>
            </Link>
          </div>
        </div>
      ...
      <FAQSection
        ...
        title="Water Heater Repair FAQ — Palo Cedro, CA"
        background="gray"
      />
      ...
      <section className="py-16 md:py-20 bg-navy-900 text-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
            Lost Hot Water in Palo Cedro? Let&apos;s Diagnose It.
          </h2>
          <p className="text-xl text-gray-200 mb-8 leading-relaxed">
            Licensed, local, and specialized in water heaters — well-water and rural homes welcome.
            Call now for same-day repair availability during business hours — we&apos;re 15 minutes
            east on Highway 44.
          </p>
