...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/water-heater-repair-redding#service',
  name: 'Water Heater Repair in Redding, CA',
  serviceType: 'Water Heater Repair',
  description:
    'Water heater repair in Redding, CA — gas and electric. We diagnose and repair thermostats, heating elements, thermocouples, gas control valves, pilot/ignition faults, and leaking T&P relief valves, with honest repair-vs-replace guidance and upfront pricing. Licensed plumber CSLB #596557, serving Redding since 1998.',
  category: 'Plumbing',
  url: 'https://toplineplumbingco.com/water-heater-repair-redding',
...
const webPageSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  '@id': 'https://toplineplumbingco.com/water-heater-repair-redding#webpage',
  url: 'https://toplineplumbingco.com/water-heater-repair-redding',
  name: 'Water Heater Repair Redding, CA | Topline Plumbing',
  description:
    "Water heater repair in Redding, CA, gas and electric. Same-day diagnostic and honest repair-vs-replace advice. Licensed since 1998. Call (530) 704-6989.",
  inLanguage: 'en-US',
  isPartOf: { '@id': 'https://toplineplumbingco.com/#website' },
  about: { '@id': 'https://toplineplumbingco.com/water-heater-repair-redding#service' },
};

export const metadata: Metadata = {
  title: 'Water Heater Repair Redding, CA | Topline Plumbing',
  description:
    "Water heater repair in Redding, CA, gas and electric. Same-day diagnostic and honest repair-vs-replace advice. Licensed since 1998. Call (530) 704-6989.",
  alternates: {
    canonical: 'https://toplineplumbingco.com/water-heater-repair-redding',
  },
  openGraph: {
    title: 'Water Heater Repair Redding, CA | Topline Plumbing',
    description:
      "Redding's water heater repair specialists. Same-day diagnostic during business hours, gas and electric, with honest repair-vs-replace guidance from a licensed local plumber since 1998.",
    url: 'https://toplineplumbingco.com/water-heater-repair-redding',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Topline Plumbing — Water Heater Repair in Redding, CA',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const waterHeaterRepairFAQs = [
  {
    question: 'How fast can you repair my water heater in Redding?',
    answer:
      "Redding is our home base, so it's the fastest territory we cover — if you call before noon during business hours (Mon–Fri 8a–4:30p), we can usually diagnose and repair the same day. We carry the common parts on the truck. Call (530) 704-6989 for current availability and we'll tell you straight whether we can be there today.",
  },
  {
    question: 'How much does water heater repair cost in Redding, CA?',
    answer:
  ...
  {
    question: 'Do you repair both gas and electric water heaters in Redding?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes. Topline Plumbing is a licensed, bonded, and insured California plumbing contractor — CSLB License #596557 — serving Redding since 1998. We stand behind our repair workmanship.',
  },
  {
    question: 'Are you available 24/7 for water heater emergencies in Redding?',
    answer:
...
export default function WaterHeaterRepairReddingPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            name: 'Water Heater Repair Redding',
            url: 'https://toplineplumbingco.com/water-heater-repair-redding',
          },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-3xl text-center lg:text-left mx-auto lg:mx-0">
            <p className="uppercase tracking-widest text-sm md:text-base text-primary-light font-semibold mb-4">
              Redding&apos;s Water Heater Repair Specialists · Licensed Since 1998
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 text-white leading-tight">
              Water Heater Repair in Redding, CA
            </h1>
            <p className="text-lg md:text-xl text-gray-200 mb-6 leading-relaxed">
              Topline Plumbing is a licensed (CSLB #596557) water heater repair service based right
              here in Redding, CA. We repair gas and electric units — thermostats, heating elements,
              thermocouples, gas valves, pilots, and leaking relief valves — with same-day service
              during business hours (Mon–Fri 8a–4:30p) and upfront pricing. Call (530) 704-6989.
            </p>
            ...
            <div className="inline-block bg-primary/15 border border-primary/40 rounded-full px-6 py-3 mb-8 text-base md:text-lg text-white font-semibold">
              <span className="text-primary-light">Right here in Redding →</span> same-day repair when
            ...
            <p className="mt-6 text-sm text-gray-300">
              ...
              8:00a–4:30p · CSLB #596557 · Based in Redding
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-3">
              Water Heater Repairs We Handle in Redding
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-6">
              Why Redding Water Heaters Need Repairs Sooner
            </h2>
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p>
                Redding is our home base, which makes it the fastest territory we cover — when a
            ...
            {[
              {
                ...
                body: "Redding is our home turf, so it's the fastest territory we cover. Call before noon during business hours and we can usually diagnose and repair the same day.",
              },
              {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                When repair isn&apos;t the right call — same-day tank and tankless replacement in Redding.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Power augering, camera inspection, and clog clearing across Redding.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Same service, 10 minutes south on I-5 in Anderson.
              </p>
            </Link>
            <Link
              href="/areas/redding"
      ...
      <FAQSection
        ...
        title="Water Heater Repair FAQ — Redding, CA"
        background="gray"
      />
      ...
      <section className="py-16 md:py-20 bg-navy-900 text-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
            Lost Hot Water in Redding? Let&apos;s Diagnose It.
          </h2>
          <p className="text-xl text-gray-200 mb-8 leading-relaxed">
            Licensed, local, and specialized in water heaters. Call now for same-day repair
            availability during business hours — we&apos;re based right here in Redding.
          </p>
