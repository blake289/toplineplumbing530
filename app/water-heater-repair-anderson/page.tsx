...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/water-heater-repair-anderson#service',
  name: 'Water Heater Repair in Anderson, CA',
  serviceType: 'Water Heater Repair',
  description:
    'Water heater repair in Anderson, CA — gas and electric. We diagnose and repair thermostats, heating elements, thermocouples, gas control valves, pilot/ignition faults, and leaking T&P relief valves, with honest repair-vs-replace guidance and upfront pricing. Licensed plumber CSLB #596557, serving the Anderson area since 1998.',
  category: 'Plumbing',
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Sediment Flush & Diagnostic',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Topline Plumbing — Water Heater Repair in Anderson, CA',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const waterHeaterRepairFAQs = [
  ...
  {
    question: 'Do you repair both gas and electric water heaters in Anderson?',
    answer:
  ...
  {
    question: 'My water heater is in a manufactured or mobile home — can you still repair it?',
    answer:
      "Yes. Many Anderson homes are manufactured or mobile homes, and their water heater closets have their own standards — the supply lines, fittings, and venting need to be handled with the correct materials. We're experienced with these installs and repairs and keep your unit compliant. Call (530) 704-6989 and tell us it's a manufactured home so we bring the right parts.",
  },
  {
    question: 'Why does my well water near Cottonwood Creek keep killing my water heater?',
    answer:
      "Well-water homes toward Cottonwood Creek often carry heavy sediment and mineral load, which settles in the bottom of the tank, insulates the burner or element, and forces early failure. A flush, an anode-rod check, and in many cases a water softener or pre-filter extend the life of the unit. We'll diagnose what's driving the failures and tell you the honest fix.",
  },
  {
    question: 'Is Topline Plumbing licensed to repair water heaters?',
    answer:
      'Yes. Topline Plumbing is a licensed, bonded, and insured California plumbing contractor — CSLB License #596557 — serving the Anderson and Redding area since 1998. We stand behind our repair workmanship.',
  },
  {
    question: 'Are you available 24/7 for water heater emergencies in Anderson?',
    answer:
...
export default function WaterHeaterRepairAndersonPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            name: 'Water Heater Repair Anderson',
            url: 'https://toplineplumbingco.com/water-heater-repair-anderson',
          },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-3xl text-center lg:text-left mx-auto lg:mx-0">
            <p className="uppercase tracking-widest text-sm md:text-base text-primary-light font-semibold mb-4">
              Anderson&apos;s Water Heater Repair Specialists · Licensed Since 1998
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 text-white leading-tight">
              Water Heater Repair in Anderson, CA
            </h1>
            <p className="text-lg md:text-xl text-gray-200 mb-6 leading-relaxed">
              Topline Plumbing is a licensed (CSLB #596557) water heater repair service for Anderson,
              CA. We repair gas and electric units — thermostats, heating elements, thermocouples, gas
              valves, pilots, and leaking relief valves — with same-day service during business hours
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-3">
              Water Heater Repairs We Handle in Anderson
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-6">
              Why Anderson Homes Call Topline for Water Heater Repair
            </h2>
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              ...
              <p>
                Anderson&apos;s manufactured and mobile homes are a big share of the water heater calls
                we run here. Those units live in tight water heater closets with their own plumbing
                standards — the supply lines, fittings, and venting have to be handled with the right
                materials, or the repair won&apos;t hold and won&apos;t be compliant. We come prepared
                for mobile-home installs specifically, so a thermocouple swap or element replacement
              ...
              <p>
                ...
                water heater on well water, we also check whether a flush, an anode rod, or a softener
                would stop the same failure from coming back. That&apos;s the honest fix, not just the
                fast one.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'Manufactured-Home Ready',
                body: "Anderson has a lot of manufactured and mobile homes. We know their water heater closets need the correct materials and venting, and we come prepared for them.",
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Same service, just up the I-5 in the city of Shasta Lake.
              </p>
            </Link>
            <Link
              href="/water-heater-replacement-redding"
      ...
      <FAQSection
        ...
        title="Water Heater Repair FAQ — Anderson, CA"
        background="gray"
      />
      ...
      <section className="py-16 md:py-20 bg-navy-900 text-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
            Lost Hot Water in Anderson? Let&apos;s Diagnose It.
          </h2>
          <p className="text-xl text-gray-200 mb-8 leading-relaxed">
            Licensed, local, and specialized in water heaters. Call now for same-day repair
            availability during business hours — we&apos;re 10 minutes south on I-5.
          </p>
