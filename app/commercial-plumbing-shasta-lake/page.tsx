...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake#service',
  name: 'Commercial Plumbing in Shasta Lake, CA',
  serviceType: 'Commercial Plumbing',
  description:
    'Commercial plumbing for Shasta Lake, CA businesses from a licensed local contractor. Backflow testing and repair, commercial water heaters, drain and sewer service, fixture and supply repairs, leak detection, and scheduled preventive maintenance for restaurants, offices, retail, vacation rentals, and small multi-unit properties. Licensed plumber CSLB #596557, based in Redding since 1998.',
  category: 'Plumbing',
  url: 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake',
...
const webPageSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  '@id': 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake#webpage',
  url: 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake',
  name: 'Commercial Plumber Shasta Lake, CA | Free Estimate',
  description:
    'Commercial plumber in Shasta Lake, CA. Backflow testing, water heaters, drains, and maintenance. Licensed since 1998. Call (530) 704-6989.',
  inLanguage: 'en-US',
  isPartOf: { '@id': 'https://toplineplumbingco.com/#website' },
  about: { '@id': 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake#service' },
};

export const metadata: Metadata = {
  title: 'Commercial Plumber Shasta Lake, CA | Free Estimate',
  description:
    'Commercial plumber in Shasta Lake, CA. Backflow testing, water heaters, drains, and maintenance. Licensed since 1998. Call (530) 704-6989.',
  alternates: {
    canonical: 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake',
  },
  openGraph: {
    title: 'Commercial Plumber Shasta Lake, CA | Free Estimate',
    description:
      'Commercial plumbing for Shasta Lake businesses: backflow testing, water heaters, drains, leak detection, and preventive maintenance from a licensed local plumber since 1998.',
    url: 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Topline Plumbing | Commercial Plumbing in Shasta Lake, CA',
      },
    ],
    locale: 'en_US',
    type: 'website',
...
const commercialShastaLakeFAQs = [
  {
    question: 'How fast can a commercial plumber get to my Shasta Lake business?',
    answer:
      "Shasta Lake is just 10 miles north of our Redding base on I-5, so during business hours (Mon–Fri 8:00a–4:30p) we typically respond the same day. When a plumbing problem is shutting down your operation (a backed-up kitchen line, a failed water heater, a leak over the sales floor), call (530) 704-6989 and we'll tell you straight whether we can be there today.",
  },
  {
    question: 'Do you offer after-hours or 24/7 commercial plumbing in Shasta Lake?',
    answer:
  ...
  {
    question: 'Do you handle backflow testing for Shasta Lake businesses?',
    answer:
      'Yes. Many commercial properties, including restaurants, properties with irrigation, and buildings on city water, are required to have their backflow assemblies tested and certified annually. As a licensed California plumbing contractor (CSLB #596557), we test and repair backflow prevention assemblies and coordinate the annual certification so you stay compliant.',
  },
  {
    question: 'Do you work with vacation rentals and property managers in Shasta Lake?',
    answer:
      "Yes. Shasta Lake's rental and cabin properties are a regular part of our work in the city. We coordinate access with tenants or guests, work with owners managing the property remotely, and provide written invoices for owner records. One licensed team across all your properties means nobody has to chase down a different contractor each time.",
  },
  {
    question: 'What types of businesses do you serve in Shasta Lake?',
    answer:
      'We work with restaurants, offices, retail shops, vacation rentals, and small multi-unit and property-managed buildings: the kind of light commercial work a licensed local shop handles well. That includes commercial water heaters, grease-prone kitchen and main drain lines, fixture and supply repairs, leak detection, and scheduled maintenance. We do not take on large-scale industrial work or new commercial construction.',
  },
  {
    question: 'How much does commercial plumbing cost in Shasta Lake, CA?',
    answer:
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          {
            name: 'Commercial Plumbing Shasta Lake',
            url: 'https://toplineplumbingco.com/commercial-plumbing-shasta-lake',
          },
        ]}
      />
      <FAQSchema faqs={commercialShastaLakeFAQs} />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-3xl text-center lg:text-left mx-auto lg:mx-0">
            <p className="uppercase tracking-widest text-sm md:text-base text-primary-light font-semibold mb-4">
              Shasta Lake Commercial Plumbing · Licensed Since 1998
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 text-white leading-tight">
              Commercial Plumbing in Shasta Lake, CA
            </h1>
            <p className="text-lg md:text-xl text-gray-200 mb-6 leading-relaxed">
              Topline Plumbing is a licensed (CSLB #596557) commercial plumbing contractor serving
              Shasta Lake, CA businesses from our Redding base, 10 miles down I-5. Same-day service
              during business hours (Mon–Fri 8a–4:30p) with upfront pricing: backflow testing,
              commercial water heaters, drains, leak detection, and preventive maintenance. Call
              (530) 704-6989.
            </p>
            ...
            <div className="inline-block bg-primary/15 border border-primary/40 rounded-full px-6 py-3 mb-8 text-base md:text-lg text-white font-semibold">
              <span className="text-primary-light">One licensed local team →</span> we work around
              your business hours to minimize downtime
            </div>
            ...
            <p className="mt-6 text-sm text-gray-300">
              Mon–Fri 8:00a–4:30p · CSLB #596557 · Same-day Shasta Lake service during business
              hours
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-3">
              Commercial Plumbing Services for Shasta Lake Businesses
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The light-commercial work a licensed local shop does best, for restaurants, offices,
              retail, vacation rentals, and small multi-unit and property-managed buildings.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: 'Annual testing and repair of backflow prevention assemblies, required for many restaurants, irrigated properties, and buildings on city water. We coordinate the certification and handle the compliance paperwork.',
              },
              {
          ...
          <p className="text-center text-gray-600 mt-8 max-w-3xl mx-auto">
            ...
            and we&apos;ll tell you honestly whether it&apos;s the right fit for a licensed local
            shop or something better suited to a large-scale industrial contractor.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              For a business, a plumbing failure isn&apos;t an inconvenience. It&apos;s lost
              revenue. Here&apos;s how we keep the disruption short.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h3 className="text-xl font-heading font-bold text-navy-900 mb-3">
                Fast Dispatch Up I-5
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Shasta Lake is 10 miles north of our Redding base, so during business hours we work
                same-day. A backed-up line or failed water heater gets handled before it costs you
                a full day.
              </p>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                We schedule into your slow periods where we can, move quickly once we&apos;re
                on-site, and keep the mess and noise away from your customers and staff.
              </p>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h3 className="text-xl font-heading font-bold text-navy-900 mb-3">Upfront Pricing</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-6">
            Why Shasta Lake Businesses Call Topline for Commercial Plumbing
          </h2>
          <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
            <p>
              Shasta Lake, the city just north of Redding anchored by Shasta Dam and the lake
              recreation economy, runs on two kinds of commercial property, and each needs
              something different from a plumber. There are the everyday storefronts, offices, and
              multi-unit buildings serving the residential side of town, including the older
              building stock near the original townsite in Project City and Central Valley. And
              there are the rentals and cabins serving lake visitors, where the property owner is
              often managing from somewhere else entirely.
            </p>
            <p>
              For the storefront side, the math is simple: a plumbing failure during operating
              hours is lost revenue, so we prioritize same-day response during business hours and
              schedule planned work into your slow periods. Most of these buildings are fed by the
              City of Shasta Lake&apos;s municipal water system, and older supply lines and water
              heaters in the aging stock near the townsite tend to fail without warning. Scheduled
              preventive maintenance (drain cleaning before lines clog, water heater checks,
              backflow testing, fixture inspections) is far cheaper than an emergency mid-service.
            </p>
            <p>
              For rental and hospitality properties, the bigger risk is the leak nobody catches. A
              property that sits unoccupied between guests can compound water damage for days
              before anyone walks in. We coordinate access when you&apos;re managing the property
              remotely, provide written invoices for owner records, and keep one licensed team
              across all your properties. It&apos;s the same commercial service we run for{' '}
              <Link
              ...
              , 10 minutes down the freeway, from the same family-owned shop that&apos;s been
          ...
          <div className="mt-10 p-6 bg-navy-900 text-white rounded-xl">
            ...
            <p className="text-gray-200 mb-4">
              We work with property managers and small multi-unit buildings: coordinate access with
              tenants, provide written invoices for owner records, and keep one licensed team
              across all your properties so nobody has to chase down a different contractor each
              time.
            </p>
            <a
              href="tel:5307046989"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-4">
              Why Shasta Lake Businesses Call Topline First
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Local, licensed, and accountable. One team that knows your property and your
              priorities.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: 'Shasta Lake is 10 minutes up I-5 from our Redding base, so during business hours we can often be on-site the same day. Fast enough to keep a clogged line or failed heater from costing you a full day of revenue.',
              },
              {
              ...
              },
              {
                ...
                body: 'CSLB License #596557. A fully licensed California plumbing contractor authorized for commercial work across Shasta Lake and Shasta County, with documentation for your records.',
              },
              {
              ...
              },
              {
                ...
                body: "Shasta Lake's rental and seasonal properties are a regular part of our work. We coordinate remote access, protect unoccupied properties, and document everything for the owner.",
              },
              {
      ...
      <section className="py-16 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-3">
              Related Plumbing Services in Shasta Lake
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Power augering and camera inspection for kitchen and main lines.
              </p>
            </Link>
            <Link
            ...
            >
              <h3 className="text-lg font-heading font-bold text-navy-900 mb-2">
                Sewer Line in Shasta Lake →
              </h3>
              <p className="text-gray-700 text-sm leading-relaxed">
                Camera-first diagnosis, repair, and replacement for main sewer lines.
              </p>
            </Link>
          </div>
          <p className="text-center text-gray-600 mt-8">
            Also serving Redding businesses?{' '}
            <Link href="/commercial-plumbing-redding" className="text-primary font-semibold hover:underline">
              Commercial plumbing in Redding
            </Link>{' '}
            ·{' '}
            <Link href="/areas/shasta-lake" className="text-primary font-semibold hover:underline">
              All Shasta Lake plumbing services
            </Link>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-2">
              Trusted by Shasta County Businesses &amp; Homeowners
            </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-navy-900 mb-4 text-center">
            Commercial Plumbing Across Shasta County
          </h2>
      ...
      {/* FAQ */}
      <FAQSection
        faqs={commercialShastaLakeFAQs}
        title="Shasta Lake, CA Commercial Plumbing FAQ"
        background="white"
      />
      ...
      <section className="py-16 md:py-20 bg-navy-900 text-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
            Keep Your Shasta Lake Business Running
          </h2>
